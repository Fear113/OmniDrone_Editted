...
class Payload(Enum):
    A1 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_A1.usd", (0.01, 0.01, 0.01),      (0.5, 0.5, 0.5),        (-1., -2, 0),   (1., 0, 0, 0), 'A1')
    A2 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_A2.usd", (0.005, 0.005, 0.005),   (0.25, 0.25, 0.25),  (1., 2, 0),     (1., 0, 0, 0), 'A2')
    B1 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_B1.usd", (0.01, 0.01, 0.01),      (0.5, 1.0, 0.5),        (0., -2, 0),    (1., 0, 0, 0), 'B1')
    B2 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_B2.usd", (0.005, 0.005, 0.005),   (0.25, 0.5, 0.25),   (-1., 2, 0),    (1., 0, 0, 0), 'B2')
    D1 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_D1.usd", (0.006, 0.006, 0.006),      (0.6, 0.9, 0.3),        (0., 3., 0),    (1., 0, 0, 0), 'D1')
    D1_s = PayloadInfo( f"{wooden_dir}/WoodenCrate_D1.usd", (0.003, 0.003, 0.003),   (0.3, 0.45, 0.15),   (0., -2, 0),    (1., 0, 0, 0), 'D1_s')
