...
class Payload(Enum):
    # A1 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_A1.usd", (0.008, 0.008, 0.008),      (0.4, 0.4, 0.4),        (-1., -2, 0),   (1., 0, 0, 0), 'A1')
    # A2 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_A2.usd", (0.0065, 0.0065, 0.0065),   (0.325, 0.325, 0.325),  (1., 2, 0),     (1., 0, 0, 0), 'A2')
    # B1 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_B1.usd", (0.008, 0.008, 0.008),      (0.4, 0.8, 0.4),        (0., -2, 0),    (1., 0, 0, 0), 'B1')
    # B2 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_B2.usd", (0.0065, 0.0065, 0.0065),   (0.325, 0.65, 0.325),   (-1., 2, 0),    (1., 0, 0, 0), 'B2')
    # D1 = PayloadInfo(   f"{wooden_dir}/WoodenCrate_D1.usd", (0.006, 0.006, 0.006),      (0.6, 0.9, 0.3),        (0., 3., 0),    (1., 0, 0, 0), 'D1')
    # D1_s = PayloadInfo( f"{wooden_dir}/WoodenCrate_D1.usd", (0.0045, 0.0045, 0.0045),   (0.45, 0.675, 0.225),   (0., -2, 0),    (1., 0, 0, 0), 'D1_s')
